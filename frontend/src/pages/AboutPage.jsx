...
export default function AboutPage() {
  return (
    <main className="bg-[#1c0828] min-h-screen">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-[#1c0828]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link to="/" className="text-sm text-[#a08aaa] hover:text-white transition-colors">Home</Link>
            <Link to="/#pricing" className="text-sm text-[#a08aaa] hover:text-white transition-colors">Pricing</Link>
            <Link
              to="/sign-up"
      ...
      <section className="relative pt-40 pb-28 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[700px] h-[700px] rounded-full opacity-[0.08]" style={{ background: "radial-gradient(circle, #33033c 0%, transparent 70%)" }} />
          <div className="absolute top-0 right-0 w-96 h-96 rounded-full opacity-5" style={{ background: "radial-gradient(circle, #e04e35 0%, transparent 70%)" }} />
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[rgba(224,78,53,0.3)] bg-[rgba(224,78,53,0.06)] mb-8">
            ...
            <span className="text-xs text-[#e04e35] font-medium tracking-wider uppercase">About Core Truth House</span>
          </div>
          ...
          <h1 className="font-display font-bold text-white leading-[1.1] mb-8" style={{ fontSize: "clamp(2.4rem, 5.5vw, 4.2rem)" }}>
            ...
            <br />
            <span style={{ color: "#e04e35", textShadow: "0 0 40px rgba(224,78,53,0.3)" }}>
              before you build the brand the world sees.
            </span>
          </h1>

          <p className="text-[#c7a09d] leading-relaxed max-w-2xl mx-auto mb-8" style={{ fontSize: "clamp(1rem, 2vw, 1.2rem)" }}>
            {BRAND_FOUNDATION.valueProp}
          </p>
          
          <p className="text-[#763b5b] text-sm italic max-w-xl mx-auto">
      ...
      <section className="py-20 bg-[#0d0010]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-10">
            {/* Vision */}
            <div className="p-8 rounded-2xl border border-[rgba(224,78,53,0.2)] bg-[rgba(51,3,60,0.3)]">
              <div className="flex items-center gap-2 mb-4">
                <span className="w-2 h-2 rounded-full bg-[#e04e35]" />
                <span className="text-xs text-[#e04e35] uppercase tracking-widest font-semibold">Vision</span>
              </div>
            ...
            <div className="p-8 rounded-2xl border border-[rgba(118,59,91,0.3)] bg-[rgba(118,59,91,0.1)]">
              <div className="flex items-center gap-2 mb-4">
                <span className="w-2 h-2 rounded-full bg-[#763b5b]" />
                <span className="text-xs text-[#763b5b] uppercase tracking-widest font-semibold">Mission</span>
              </div>
              <p className="font-display text-white leading-relaxed text-lg">
      ...
      {/* The Origin */}
      <section className="py-24 bg-[#140620]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-xs text-[#e04e35] uppercase tracking-widest font-medium mb-4">Why Core Truth House Exists</p>
              <h2 className="font-display font-bold text-white leading-tight mb-6" style={{ fontSize: "clamp(1.8rem, 3vw, 2.6rem)" }}>
                ...
                <br />
                <span className="text-[#763b5b]">It was always infrastructure.</span>
              </h2>
              <p className="text-[#a08aaa] leading-relaxed mb-5">
              ...
              <p className="text-[#a08aaa] leading-relaxed">
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  <p className="text-xs font-semibold uppercase tracking-widest mb-4" style={{ color: col.bad ? "#8B0000" : "#e04e35" }}>
                    {col.label}
                  </p>
                  <div className="space-y-2">
                    {col.items.map((item, j) => (
                      <div key={j} className="flex items-center gap-3 text-sm">
                        <span style={{ color: col.bad ? "#8B0000" : "#e04e35", fontSize: "10px" }}>
                          {col.bad ? "✕" : "✓"}
                        </span>
                        <span style={{ color: col.bad ? "#763b5b" : "#c7a09d" }}>{item}</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      {/* Philosophy */}
      <section className="py-28 bg-[#1c0828]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="text-xs text-[#e04e35] uppercase tracking-widest font-medium mb-4">The Operating Philosophy</p>
            ...
            <p className="text-[#a08aaa] max-w-xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {PRINCIPLES.map((p) => (
              <div
                key={p.number}
                className="relative p-7 rounded-2xl border border-white/5 bg-[#2b1040] group hover:border-[rgba(224,78,53,0.3)] transition-all duration-300"
              >
                ...
                <div className="text-sm font-bold mb-1" style={{ color: "#e04e35", fontFamily: "monospace" }}>
                  {p.number}
                </div>
                <h3 className="font-display font-semibold text-white text-base mb-3 leading-snug">{p.title}</h3>
                <p className="text-sm text-[#a08aaa] leading-relaxed">{p.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Methodology */}
      <section className="py-28 bg-[#140620]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div className="md:sticky md:top-24">
              <p className="text-xs text-[#e04e35] uppercase tracking-widest font-medium mb-4">The Methodology</p>
              <h2 className="font-display font-bold text-white leading-tight mb-6" style={{ fontSize: "clamp(1.8rem, 3vw, 2.6rem)" }}>
                The Brand Operating System.
                <br />
                <span className="text-[#763b5b]">Five layers. One connected system.</span>
              </h2>
              ...
              <div className="p-5 rounded-2xl border" style={{ background: "rgba(224,78,53,0.06)", borderColor: "rgba(224,78,53,0.2)" }}>
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-[#e04e35] text-sm">◐</span>
                  <span className="text-xs text-[#e04e35] uppercase tracking-widest font-medium">Powered by Brand Memory</span>
                </div>
                <p className="text-sm text-[#c7a09d] leading-relaxed">
            ...
            <div className="space-y-4">
              {METHODOLOGY_STEPS.map((step, i) => (
                <div key={i} className="flex gap-5 p-6 rounded-2xl border border-white/5 bg-[#2b1040]">
                  <div className="flex-shrink-0 flex flex-col items-center">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold text-white" style={{ background: "linear-gradient(135deg, #e04e35, #af0024)" }}>
                      {i + 1}
                    </div>
                  ...
                  <div className="pt-1">
                    ...
                    <p className="text-sm text-[#a08aaa] leading-relaxed">{step.description}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* The Mission */}
      <section className="py-28 bg-[#1c0828] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <p className="text-xs text-[#e04e35] uppercase tracking-widest font-medium mb-6">The Mission</p>
          <blockquote className="font-display font-bold text-white leading-tight mb-8" style={{ fontSize: "clamp(1.8rem, 3.5vw, 3rem)" }}>
            ...
            <em className="not-italic" style={{ color: "#e04e35" }}>agencies and big budgets.</em>"
          </blockquote>
          <p className="text-[#a08aaa] leading-relaxed max-w-2xl mx-auto text-lg mb-6">
          ...
          <p className="text-[#763b5b] leading-relaxed max-w-xl mx-auto">
      ...
      {/* Final CTA */}
      <section className="py-28 bg-[#140620] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          <div className="w-14 h-14 mx-auto mb-8 rounded-2xl flex items-center justify-center text-xl" style={{ background: "linear-gradient(135deg, #e04e35, #af0024)", boxShadow: "0 0 32px rgba(224,78,53,0.35)" }}>
            ⌂
          </div>
          ...
          <h2 className="font-display font-bold text-white mb-5 leading-tight" style={{ fontSize: "clamp(1.8rem, 3.5vw, 3rem)" }}>
            ...
            <br />
            <span style={{ color: "#e04e35" }}>has always been inside the business.</span>
          </h2>

          <p className="text-[#c7a09d] mb-10 leading-relaxed text-lg max-w-xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link
              ...
              style={{ background: "linear-gradient(135deg, #e04e35, #af0024)", boxShadow: "0 8px 32px rgba(224,78,53,0.4)" }}
            >
              Start Building Your Brand
            </Link>
            <a
              href="/#pricing"
              className="px-10 py-4 rounded-2xl text-[#c7a09d] font-medium text-base border border-white/10 hover:border-[rgba(224,78,53,0.4)] hover:text-white transition-all"
            >
              View Pricing
            </a>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-white/5 bg-[#1c0828] py-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center text-white text-xs" style={{ background: "linear-gradient(135deg, #e04e35, #af0024)" }}>
              ⌂
            </div>
            <span className="font-display text-sm font-bold text-[#763b5b]">Core Truth House</span>
          </div>
          <div className="flex items-center gap-6">
            {[
              ...
              <Link key={item.label} to={item.href} className="text-xs text-[#4a3550] hover:text-[#a08aaa] transition-colors">
                {item.label}
              </Link>
            ))}
          </div>
