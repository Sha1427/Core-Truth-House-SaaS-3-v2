            ...
            <div key={msg.id} data-testid={`message-${msg.id}`}
              className={`p-4 rounded-xl border transition-all cursor-pointer ${
                selectedMessages.has(msg.id)
                  ? 'bg-[#2b1040] border-[#e04e35]/50 ring-1 ring-[#e04e35]/30'
                  : msg.status === 'new'
                    ? 'bg-[#2b1040] border-[#e04e35]/30 hover:border-[#e04e35]/50'
                    : 'bg-[#2b1040] border-white/10 hover:border-white/20'
              }`}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {msg.status === 'new' && <span className="px-2 py-0.5 bg-[#e04e35]/20 text-[#e04e35] text-xs rounded-full">New</span>}
                  ...
                  <div className="text-xs text-[#e04e35] mb-1 font-medium">{msg.subject}</div>
