...
import { Workflow, GitBranch, Bot, ShieldCheck } from "lucide-react";
    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-[var(--cth-admin-border)] bg-white p-6 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h2 className="mt-1 text-3xl font-semibold text-[var(--cth-admin-ink)]">Workflows</h2>
          </div>
        </div>
        <p className="mt-3 max-w-2xl text-sm text-[var(--cth-admin-muted)]">
          Centralize workflow orchestration, automation governance, and future system flow controls inside the new separated admin shell.
        </p>
      </section>

      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <StatCard icon={Workflow} label="Workflow Surface" value="Ready" tone="rose" />
        <StatCard icon={GitBranch} label="Orchestration Layer" value="Planned" tone="plum" />
        <StatCard icon={Bot} label="Automation Control" value="Next" tone="gold" />
      ...
      <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="grid gap-4">
            <div className="rounded-xl border border-[var(--cth-admin-border)] bg-[var(--cth-admin-panel)] p-4">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <div className="text-sm font-semibold text-[var(--cth-admin-ink)]">Workflow Inventory</div>
                  <div className="mt-1 text-xs text-[var(--cth-admin-muted)]">
                    Future home for registered workflows, operational flows, and automation visibility.
                  </div>
                </div>
            ...
            <div className="rounded-xl border border-[var(--cth-admin-border)] bg-[var(--cth-admin-panel)] p-4">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <div className="text-sm font-semibold text-[var(--cth-admin-ink)]">Execution Governance</div>
                  <div className="mt-1 text-xs text-[var(--cth-admin-muted)]">
                    Future controls for workflow triggers, execution health, and administrative oversight.
                  </div>
                </div>
            ...
            <div className="rounded-xl border border-[var(--cth-admin-border)] bg-[var(--cth-admin-panel)] p-4">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <div className="text-sm font-semibold text-[var(--cth-admin-ink)]">Automation Standards</div>
                  <div className="mt-1 text-xs text-[var(--cth-admin-muted)]">
                    Future place for rules, safeguards, and system-level workflow governance.
                  </div>
                </div>
        ...
        <PanelCard
          ...
          subtitle="Native admin placeholder for orchestration controls"
        >
          <div className="grid gap-4">
            <div className="rounded-xl border border-dashed border-[var(--cth-admin-border)] bg-[var(--cth-admin-panel)] p-4">
              <div className="text-sm font-semibold text-[var(--cth-admin-ink)]">Workflow Registry</div>
              <div className="mt-2 text-sm text-[var(--cth-admin-muted)]">
                Future home for flow definitions, workflow cataloging, and automation discovery.
              </div>
            </div>

            <div className="rounded-xl border border-dashed border-[var(--cth-admin-border)] bg-[var(--cth-admin-panel)] p-4">
              <div className="text-sm font-semibold text-[var(--cth-admin-ink)]">Run Monitoring</div>
              <div className="mt-2 text-sm text-[var(--cth-admin-muted)]">
                Future controls for execution logs, run visibility, and failed workflow review.
              </div>
            </div>

            <div className="rounded-xl border border-dashed border-[var(--cth-admin-border)] bg-[var(--cth-admin-panel)] p-4">
              <div className="text-sm font-semibold text-[var(--cth-admin-ink)]">Automation Governance</div>
              <div className="mt-2 text-sm text-[var(--cth-admin-muted)]">
                Future place to manage safeguards, triggers, dependencies, and workflow standards.
              </div>
            </div>
          </div>
        </PanelCard>
