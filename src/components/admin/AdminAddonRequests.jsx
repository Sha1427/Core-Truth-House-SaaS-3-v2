        ...
        <div className="space-y-3">
          {addonRequests.map((req) => {
            ...
            return (
              <div
                key={req.id}
                className="p-5 rounded-xl bg-[var(--cth-admin-ink)] border border-white/10"
              >
                  ...
                  <div className="flex-1">
                    ...
                    {req.admin_notes && (
                      <div className="mt-3 p-3 rounded-lg bg-white/5 border border-white/5">
                        <div className="text-xs text-[var(--cth-admin-accent)] font-semibold mb-1 flex items-center gap-1">
                  ...
                  <div className="flex flex-col gap-1">
                    {(req.status === 'pending' || req.status === 'under_review') && (
                      <button
                        ...
                        disabled={isBusy}
                        className="p-2 rounded-lg text-[var(--cth-admin-muted)] hover:bg-white/5 transition-colors disabled:opacity-50"
                        title="Add Notes"
                      >
                  ...
                  <div className="mt-3 pt-3 border-t border-white/5">
                    ...
                    <div className="flex gap-2 mt-2">
                      <button
                        ...
                        disabled={isBusy}
                        className="flex items-center gap-1 px-3 py-1.5 bg-[var(--cth-admin-accent)] rounded-lg text-white text-xs font-medium disabled:opacity-50"
                      >
                        {isBusy ? (
